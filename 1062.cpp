...
///https://ojsolver.blogspot.com/2016/04/uva-10566-lightoj-1062-crossed-ladders.html?fbclid=IwAR0TfBb7s8hLGIuNa6oInqFR_tSeErs7Cfw2F_EmBs-rOmWE4GIbGhzgTko
double bisec(double x,double y,double h )
{
    double tmp_h,h1,h2,low = 0.0,mid, high = min(x,y);
    int tt=100;
    while(tt--)
    {
        mid = (low+high)/2.0;
